...
| Skill | Plane | Reuses |
|---|---|---|
| `cf-workers-deploy` | `wrangler.jsonc`, envs, secrets, builds/observability triage, CI via `wrangler-action`, Turnstile + audit pre-deploy gates | `wrangler`, `workers-best-practices` |
